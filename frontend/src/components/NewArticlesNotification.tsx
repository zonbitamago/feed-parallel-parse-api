...
export function NewArticlesNotification({
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="fixed top-16 left-1/2 transform -translate-x-1/2 z-50 bg-green-500 text-white px-6 py-3 rounded-lg shadow-lg flex items-center gap-4 animate-slide-down"
    >
